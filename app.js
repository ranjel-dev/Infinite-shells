...
function hideGame(hide){
  shellLayer.style.visibility = hide ? "hidden" : "visible";
  pearl.style.visibility = hide ? "hidden" : "visible";
}
...
async function boot(){
  ...
  titleCta.style.display = SHOW_TITLE_CTA_OVERLAY ? "block" : "none";
